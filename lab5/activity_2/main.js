...
function updateChart(filterKey) {
    ...
    //after filtering go back through all exisiting bar groups and add rectangles and letter labels
    let groups = chartG.selectAll(".bar")
    groups.attr("transform",function(d,i){return "translate(0," + ((i + 0.2) * barBand) + ")"})
    groups.append("rect")
